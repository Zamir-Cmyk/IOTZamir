...
int linearSearch(const vector<int>& arr, int target) {
  ...
  return -1; //Mengambul -1 jika tidak ditemukan
}

//Binary Search - mencari pada array yang sudadh terurut
  ...
  do {
    ...
    switch (pilihan) {
      case 1://Linear Search
		...
		//Menampilkan pembagian komplexitas
		cout << "\n=== PERBANDINGAN KOMPLEKSITAS ===" << endl;
		cout << "Linear Search: 0(n) - Waktu linear" << endl;
		cout << "Binary Search: 0(log n) - Waktu logaritmik" << endl;
		cout << "==================================" << endl;
